 ...
 */
package org.cobwebos.devops.core;

import java.io.File;

import org.cobwebos.devops.core.utils.CliUtil;
import org.cobwebos.devops.core.utils.CobwebosUtils;
...
public class Activator implements BundleActivator {
	...
	public void doStop() {
		log.info("Stopping the cobwebos devops platform");
		String command = CobwebosUtils.getInstance().getCobwebosRootDir() + "bin" + File.separator
				+ "stop-cobwebos-devops.sh";
		if (CobwebosUtils.getInstance().isWindows()) {
			command = CobwebosUtils.getInstance().getCobwebosRootDir() + "bin" + File.separator + "stop-cobwebos-devops.bat";
		}
		log.info("getCobwebosRootDir:" + CobwebosUtils.getInstance().getCobwebosRootDir());
		log.info("command:" + command);
		CliUtil cli = new CliUtil();
